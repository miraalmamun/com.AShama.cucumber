...
import com.AShama.util.ExtentManager;
...
public class WebConnector {
	...
	public void validateLogin(String expectedResult) {
		infoLog("ExpectedResult is passing " + expectedResult);
		boolean result=isElementPresent("stockLink_xpath");
		String actualResult="";
	...
	public boolean isElementPresent(String objectKey) {
		infoLog("isElementPresent " + objectKey);
	...
	public void quit() {
	  ...
	  public void initReports(String scenarioName) { rep =
	  ExtentManager.getInstance(prop.getProperty("reportPath")); scenario =
	  rep.createTest(scenarioName); scenario.log(Status.INFO, "Starting " +
	  scenarioName); }
